...
class DocumentationController extends Controller
{
    ...
    protected function renderDocumentation(Request $request, bool $isPublic): View
    {
        ...
        // Get logo URL
        $logoUrl = null;
        if (function_exists('restaurant') && restaurant() && restaurant()->logo) {
            $logoUrl = url('user-uploads/logo/' . restaurant()->logo);
        } elseif (function_exists('global_setting') && global_setting() && global_setting()->logo) {
            $logoUrl = url('user-uploads/logo/' . global_setting()->logo);
        }
