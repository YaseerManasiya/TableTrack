<div class="w-full overflow-y-auto max-h-screen [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-thumb]:bg-gray-600 [&::-webkit-scrollbar]:w-2.5">
    @php
                ...
                <div class="flex-1">
                    <form action="#" method="GET">
                        ...
                        <div class="relative">
                            ...
                            <x-input class="block w-full pl-10 pr-10 py-2 border-gray-200 rounded-lg text-sm" type="text"
