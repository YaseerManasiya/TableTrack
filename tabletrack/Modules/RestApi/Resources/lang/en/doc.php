...
return [
    ...
    'login_note_token' => 'Send the returned token as Authorization: Bearer on every request.',
    ...
    'orders_resilient' => 'Endpoint returns base pagination even if enrichment fails.',
    'orders_detail' => 'Fetch a single order with totals, discount, charges, taxes.',
    'orders_status' => 'Update order status (placed, confirmed, preparing, served, delivered, cancelled).',
    'orders_pay' => 'Pay an order with payment records.',
    'orders_detail_dinein' => 'Dine-in shows table, waiter, customer, items, charges, taxes.',
    'orders_invoice' => 'Invoice layout with items, sub_total, discount, tax, charges, grand_total.',
    'orders_status_flow' => 'Move orders: placed -> confirmed/preparing -> served/delivered.',
    'orders_pay_note' => 'Marking paid releases table and updates amount_paid.',
    'orders_discount_note' => 'Discounts on order (discount_type/value/amount).',
    'orders_table_waiter' => 'Waiter/table reassignment via order update.',
    'orders_customer_note' => 'Attach customer_id or create via POST /pos/customers.',
    'orders_print_note' => 'Printing via POS/printer flow.',
    ...
    'reservations_today' => 'Todays reservations shortcut.',
    ...
    'waiters' => 'List waiters/delivery staff.',
    'delivery_executives' => 'List delivery executives with status filters.',
    ...
    'customer_order_note' => 'Include customer_address_id for delivery.',
    'customer_orders' => 'List customer orders for current token.',
    'notifications_title' => 'Notifications',
    'notifications_desc' => 'Register device tokens and fetch notifications.',
    'notifications_register' => 'Register device token for push.',
    'notifications_list' => 'List notifications for current user.',
    'notifications_read' => 'Mark notification as read.',
    'notifications_test' => 'Send a test notification.',
    'sdks_title' => 'SDK Examples',
    'sdks_desc' => 'Use any language to consume endpoints with bearer auth.',
    ...
    'gateways_summary' => 'Payment gateway meta for restaurant.',
    'staff_summary' => 'List staff scoped to restaurant.',
    'roles_summary' => 'List role names attached to restaurant.',
    'areas_summary' => 'List delivery areas for branch.',
    'customer_addresses' => 'List customer addresses by customer_id.',
    'multipos_title' => 'MultiPOS Devices',
    'multipos_desc' => 'Register and check POS machines for branch.',
    'multipos_register' => 'Register a POS device',
    'multipos_check' => 'Check POS device status',
    'login_note_rate_limit' => 'Rate limited: 5 requests per minute.',
    'price_fallback_note' => 'Item price is optional. Fetched from MenuItem if zero.',
    'order_number_lock_note' => 'Uses DB locking to prevent duplicate order numbers.',
    'delivery_executives_note' => 'Filter by ?status=available|in_delivery|inactive.',
    'idempotency' => 'Use idempotency key to prevent duplicates.',
    'update_order_items' => 'Update order items (add, update quantity, or remove)',
    'update_items_note' => 'Actions: add, update, remove. Recalculates totals.',
    'create_kot' => 'Create a new KOT for existing order',
    'create_kot_note' => 'If order_item_ids empty, all items included. Updates status.',
    'add_tip' => 'Add a tip to an existing order',
    'add_tip_note' => 'Tip is added to order total. Can be updated before payment.',
    'split_payments' => 'Split order payment across multiple methods',
    'split_payments_note' => 'Supports cash, card, and other payment methods. Total must match order amount.',
    'customer_addresses_create' => 'Create a new customer address',
    'customer_addresses_update' => 'Update an existing customer address',
    'customer_addresses_delete' => 'Delete a customer address',
];
